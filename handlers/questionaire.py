...
async def form_age(messaage: Message, state: FSMContext):
    if messaage.text.isdigit():
        await state.update_data(age=messaage.text)
        ...
        await messaage.answer("Введи число еще раз!")
